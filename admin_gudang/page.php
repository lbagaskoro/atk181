...
<?php 
    ...
    if ($page == 'formpesan') {
    ...
    }  else if ($page=="allmaterial") {
        include_once "allmaterial.php";
        ...
        include_once "datapesanan_tgl.php";
    } else if($page == "editpesanan"){
        include_once "editpesanan.php";
    } else if($page == "tambahstok"){
        include_once "tambah_stok.php";
    }
 ?>
