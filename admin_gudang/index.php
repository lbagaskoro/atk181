...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?p=datapesanan"><i class="fa fa-files-o"></i> <span>Data Permintaan ATK</span></a></li>
        ...
        <!-- <li><a href="?p=tambahstok"><i class="fa fa-plus"></i> <span>Input Stok Barang Masuk</span></a></li>-->
  ...
  <footer class="main-footer">
	<marquee hspace="40" width="full-width">Admin Gudang mengolah data user dan data stok ATK.</marquee>
