                    ...
                    <div class="box-body">
                     <div class="row">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-4">
                                <input type="text" value="<?= $row2['unit'];  ?>" required  class="form-control" name="unit">
                            </div>
                        </div>                       
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <option value="">--Pilih Level--</option>
                                    ...
                                    <option  <?php if($row2['level'] == "user") echo "selected"; ?>  value="user">User</option>
                                    <option  <?php if($row2['level'] == "admin_gudang") echo "selected"; ?> value="admin_gudang">Admin Gudang Pengadaan</option>
                                    <option  <?php if($row2['level'] == "admin_logistik") echo "selected"; ?> value="admin_logistik">Admin Logistik</option>
