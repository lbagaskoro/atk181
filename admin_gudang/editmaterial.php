                ...
                <form method="post"  action="edit_proses.php" class="form-horizontal">
                    <div class="box-body">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control tanggal" value="<?= $row2['tgl_masuk']; ?>" name="tgl_masuk" readonly>
                            </div>
                        </div>
                        <div class="form-group ">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select readonly id="jenis_brg" required="isikan dulu" class="form-control" name="id_jenis">
                                <option value="" readonly>--Pilih Jenis Material--</option>
                                <?php  
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="<?= $row2['satuan']; ?>" name="satuan" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="harga" class="col-sm-offset-1 col-sm-3 control-label">Harga</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="<?= $row2['harga']; ?>" name="harga" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Stok Masuk</label>
                            <div class="col-sm-4">
                                <input type="number" class="form-control" name="stokmasuk"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Jumlah</label>
                            <div class="col-sm-4">
                                <input type="number" class="form-control" value="<?= $row2['stok']; ?>" name="jumlah" readonly >
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="submit" name="update" class="btn btn-primary col-sm-offset-4 " value="Simpan" > 
                            &nbsp;
                            <a href="index.php?p=allmaterial"><input type="button"class="btn btn-danger" value="Batal"></a>                                                                              
                        </div>
                    </div>
                </form>
            </div>
