                                ...
                                <tr>
                                    <?php 
                                     ...
                                     ?>
                                        ...
                                        <td>        
										<a target="_blank" href="cetakpesanan.php?&tgl=<?= $row['tgl_permintaan']; ?>&unit=<?= $row['unit']; ?>"><span data-placement='top' data-toggle='tooltip' title='Cetak BPP'><button class="btn btn-success"><i class="fa fa-print"> Download PDF</i></button></span></a>                  
                                        </td>
								</tr>        
