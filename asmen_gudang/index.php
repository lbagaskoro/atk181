...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center"><?=  $_SESSION['username']; ?> GA LOGISTIK </h4></li>
        ...
        <li><a href="index.php?p=disetujui"><i class="fa fa-files-o"></i> Data Pengeluaran ATK</a></li>
        
		<li class="treeview">
          <a href="index.php?p=material">
  ...
  <footer class="main-footer">    
	<marquee hspace="40" width="full-width">Admin Logistik berhak menentukan ATK apa saja yang boleh dikeluarkan dari Gudang, sesuai dengan kebutuhan di lapangan.</marquee>
	<strong>Copyright 2022 &copy; IT-Support</strong></footer>
